...
void main()
{
	...
	vec2 uv_coord1 = vec2(uv_coord.x + uni_phase * 1, uv_coord.y + uni_phase * 1);
	vec2 uv_coord2 = vec2(uv_coord.x + uni_phase * 1, uv_coord.y + uni_phase * 1);
	vec2 uv_coord3 = vec2(uv_coord.x + uni_phase * 1, uv_coord.y + uni_phase * 1);
